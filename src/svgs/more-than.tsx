const MoreThan = () => (
  <svg
    ...
    fill="none"
  >
    <path fill="url(#moreThan)" d="M0 0h60v60H0z" />
    <defs>
      <pattern
        id="moreThan"
        width={1}
